...
export class ScrumboardMockApi
{
    ...
    private boardsData : any[] =[];


    /**
     * Constructor
     */
    constructor(private _fuseMockApiService: FuseMockApiService ,private  _boardsservice: BoardssService)
    {
    ...
    private _boards: any[] = this.boardsData;
    ...
    {
        this._boardsservice.getboardList().subscribe(data => {
