...
export class ScrumboardService
{
     ...
     * Get boards
     */
    getBoards(): Observable<Boardss[]>
    {
        return this._httpClient.get<Boardss[]>('api/apps/scrumboard/boards').pipe(
            map(response => response.map(item => new Boardss(item))),
     ...
     * @param id
     */
    getBoard(id: string): Observable<Boardss>
    {
        return this._httpClient.get<Boardss>('api/apps/scrumboard/board', {params: {id}}).pipe(
            map(response => new Boardss(response)),
     ...
     * @param board
     */
    createBoard(board: Boardss): Observable<Boardss>
    {
        return this.boards$.pipe(
            take(1),
            switchMap(boards => this._httpClient.put<Boardss>('api/apps/scrumboard/board', {board}).pipe(
                map((newBoard) =>
                {
     ...
     * @param board
     */
    updateBoard(id: string, board: Boardss): Observable<Boardss>
    {
        return this.boards$.pipe(
            take(1),
            switchMap(boards => this._httpClient.patch<Boardss>('api/apps/scrumboard/board', {
                id,
                board,
            }).pipe(
                map((updatedBoard) =>
